...
const Globe = () => {
  useEffect(() => {
    if (typeof window !== "undefined") {
      let container = document.getElementById("globeCanvas");
      ...
      // var curveQuad = new THREE.SplineCurve3([start, middle, end]);

      // var tube1 = new THREE.TubeGeometry(curveQuad, numPoints, 0.01, 20, false);

      var tube1 = new THREE.BufferGeometry().fromGeometry(curveQuad);
      curveQuad.getPoints(numPoints);
