      ...
      class Gradient {
        ...
        async connect() {
          (this.shaderFiles = {
            ...
            window.document.querySelectorAll("canvas").length < 1
        ...
        showGradientLegend() {
          this.width > this.minWidth &&
            ...
            window.document.body.classList.add("isGradientLegendVisible"));
        }
        hideGradientLegend() {
          (this.isGradientLegendVisible = !1),
            window.document.body.classList.remove("isGradientLegendVisible");
        }
        init() {
